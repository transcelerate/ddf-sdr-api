...
namespace TransCelerate.SDR.DataAccess.Repositories
{
    public class StudyRepositoryV4 : IStudyRepositoryV4
    {
        ...
        {
            _logger.LogInformation($"Started Repository : {nameof(StudyRepositoryV4)}; Method : {nameof(GetStudyItemsAsync)};");
            try
            {
            ...
            {
                _logger.LogInformation($"Ended Repository : {nameof(StudyRepositoryV4)}; Method : {nameof(GetStudyItemsAsync)};");
            }
        }
        ...
        {
            _logger.LogInformation($"Started Repository : {nameof(StudyRepositoryV4)}; Method : {nameof(GetPartialStudyDesignItemsAsync)};");
            try
            {
                IMongoCollection<StudyDefinitionsEntity> collection = _database.GetCollection<StudyDefinitionsEntity>(Constants.Collections.StudyDefinitions);
            ...
            {
                _logger.LogInformation($"Ended Repository : {nameof(StudyRepositoryV4)}; Method : {nameof(GetPartialStudyDesignItemsAsync)};");
            }
        }       
        #endregion
        ...
        {
            _logger.LogInformation($"Started Repository : {nameof(StudyRepositoryV4)}; Method : {nameof(PostStudyItemsAsync)};");
            try
            {
                IMongoCollection<StudyDefinitionsEntity> collection = _database.GetCollection<StudyDefinitionsEntity>(Constants.Collections.StudyDefinitions);
            ...
            {
                _logger.LogInformation($"Ended Repository : {nameof(StudyRepositoryV4)}; Method : {nameof(PostStudyItemsAsync)};");
            }
        }
        #endregion
        ...
        {
            _logger.LogInformation($"Started Repository : {nameof(StudyRepositoryV4)}; Method : {nameof(UpdateStudyItemsAsync)};");
            try
            {
                IMongoCollection<StudyDefinitionsEntity> collection = _database.GetCollection<StudyDefinitionsEntity>(Constants.Collections.StudyDefinitions);
            ...
            {
                _logger.LogInformation($"Ended Repository : {nameof(StudyRepositoryV4)}; Method : {nameof(UpdateStudyItemsAsync)};");
            }
        }
        #endregion
        ...
        {
            _logger.LogInformation($"Started Repository : {nameof(StudyRepositoryV4)}; Method : {nameof(DeleteStudyAsync)};");
            try
            {
                IMongoCollection<StudyDefinitionsEntity> collection = _database.GetCollection<StudyDefinitionsEntity>(Constants.Collections.StudyDefinitions);
            ...
            {
                _logger.LogInformation($"Ended Repository : {nameof(StudyRepositoryV4)}; Method : {nameof(DeleteStudyAsync)};");
            }
        }
        /// <summary>
        /// Count Documents
        ...
        {
            _logger.LogInformation($"Started Repository : {nameof(StudyRepositoryV4)}; Method : {nameof(CountAsync)};");
            try
            {
                IMongoCollection<StudyDefinitionsEntity> collection = _database.GetCollection<StudyDefinitionsEntity>(Constants.Collections.StudyDefinitions);
                var builder = Builders<StudyDefinitionsEntity>.Filter.Eq(x => x.Study.Id, study_uuid);
            ...
            {
                _logger.LogInformation($"Ended Repository : {nameof(StudyRepositoryV4)}; Method : {nameof(CountAsync)};");
            }
        }
        #endregion
        ...
        {
            _logger.LogInformation($"Started Repository : {nameof(StudyRepositoryV4)}; Method : {nameof(GetUsdmVersionAsync)};");
            try
            {
                IMongoCollection<StudyDefinitionsEntity> collection = _database.GetCollection<StudyDefinitionsEntity>(Constants.Collections.StudyDefinitions);
            ...
            {
                _logger.LogInformation($"Ended Repository : {nameof(StudyRepositoryV4)}; Method : {nameof(GetUsdmVersionAsync)};");
            }
        }
        #endregion
        #endregion
