...
namespace TransCelerate.SDR.UnitTesting
{
    public class HelperV4ClassesUnitTesting
    {
        ...
        {
            var studyDto = GetDtoDataFromStaticJson();
            Assert.IsTrue(UniquenessArrayValidator.ValidateArrayV4(studyDto.Study.StudyIdentifiers));
            studyDto.Study.StudyIdentifiers.Add(studyDto.Study.StudyIdentifiers[0]);
            Assert.IsFalse(UniquenessArrayValidator.ValidateArrayV4(studyDto.Study.StudyIdentifiers));
        ...
        public void RefernceIntegrity_UnitTesting()
        {
            ...
            studyDto.Study.StudyDesigns[0].Activities[0].NextId = "124";
            studyDto.Study.StudyDesigns[0].Activities[0].PreviousId = "127";

            studyDto.Study.StudyDesigns[0].Activities[1].Id = "124";
            studyDto.Study.StudyDesigns[0].Activities[1].NextId = "234";
            studyDto.Study.StudyDesigns[0].Activities[1].PreviousId = "123";
            ...
            studyDto.Study.StudyDesigns[0].Encounters[0].NextId = "124";
            studyDto.Study.StudyDesigns[0].Encounters[0].PreviousId = "127";

            studyDto.Study.StudyDesigns[0].Encounters[1].Id = "124";
            studyDto.Study.StudyDesigns[0].Encounters[1].NextId = "234";
            studyDto.Study.StudyDesigns[0].Encounters[1].PreviousId = "123";
