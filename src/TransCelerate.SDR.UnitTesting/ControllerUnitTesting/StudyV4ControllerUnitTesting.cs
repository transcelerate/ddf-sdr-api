...
namespace TransCelerate.SDR.UnitTesting.ControllerUnitTesting
{
    public class StudyV4ControllerUnitTesting
    {
        ...
        public void PostAllElementsFailureUnitTesting()
        {
            ...
            method = studyV4Controller.PostAllElements(null, Constants.USDMVersions.V3);
            method.Wait();
        ...
        public void PutStudyFailureUnitTesting()
        {
            ...
            method = studyV4Controller.PutStudy(null, study.Study.Id, Constants.USDMVersions.V3);
            method.Wait();
            result = method.Result;
        ...
        public void ValidateUsdmConformanceFailureUnitTesting()
        {
            ...
            var method = studyV4Controller.ValidateUsdmConformance(null, Constants.USDMVersions.V3);
