...
{
    public interface IStudyServiceV4
    {
        #region GET Methods
        /// <summary>
        ...
        /// <see langword="null"/> If no study is matching with studyId
        /// </returns>
        Task<object> GetSOAV4(string studyId, string studyDesignId, string scheduleTimelineId, int sdruploadversion);
        ...
        /// <see langword="null"/> If no study is matching with studyId
        /// </returns>
        Task<object> GeteCPTV4(string studyId, int sdruploadversion, string studyDesignId);
        ...
        /// <see langword="null"/> If no study is matching with studyId
        /// </returns>
        Task<object> GetDifferences(string studyId, int sdrUploadVersionOne, int sdrUploadVersionTwo);
        #endregion
