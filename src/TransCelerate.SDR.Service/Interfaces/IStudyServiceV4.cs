...
namespace TransCelerate.SDR.Services.Interfaces
{
    public interface IStudyServiceV4
    {
        ...
        /// <see langword="null"/> If no study is matching with studyId
        /// </returns>
        Task<object> GetSOAV4(string studyId, string studyDesignId, string scheduleTimelineId, int sdruploadversion, LoggedInUser user);
        /// <summary>
        /// GET Study Designs of a Study
        /// </summary>
        /// <param name="studyId">Study ID</param>
        ...
        /// <see langword="null"/> If no study is matching with studyId
        /// </returns>
        Task<object> GeteCPTV4(string studyId, int sdruploadversion, string studyDesignId, LoggedInUser user);
