...
{
    public interface IStudyServiceV5
    {
        #region GET Methods
        /// <summary>
        ...
        /// <see langword="null"/> If no study is matching with studyId
        /// </returns>
        Task<object> GetSOAV5(string studyId, string studyDesignId, string scheduleTimelineId, int sdruploadversion);
        ...
        /// <see langword="null"/> If no study is matching with studyId
        /// </returns>
        Task<object> GeteCPTV5(string studyId, int sdruploadversion, string studyDesignId);
