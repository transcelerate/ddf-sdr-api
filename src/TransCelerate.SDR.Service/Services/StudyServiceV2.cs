...
namespace TransCelerate.SDR.Services.Services
{
    public class StudyServiceV2 : IStudyServiceV2
    {
        ...
        /// <see langword="null"/> If no study is matching with studyId
        /// </returns>
        public async Task<object> GetSOAV2(string studyId, string studyDesignId, string scheduleTimelineId, int sdruploadversion)
        {
            try
            {
        ...
        /// <see langword="null"/> If no study is matching with studyId
        /// </returns>
        public async Task<object> GeteCPTV2(string studyId, int sdruploadversion, string studyDesignId)
        {
            try
            {
        ...
        public async Task<object> PostAllElements(StudyDefinitionsDto studyDTO, string method)
        {
            try
            {
                ...
                StudyDefinitionsEntity incomingStudyEntity = new()
                {
                    ...
                    AuditTrail = _helper.GetAuditTrail(Constants.USDMVersions.V1_9),
