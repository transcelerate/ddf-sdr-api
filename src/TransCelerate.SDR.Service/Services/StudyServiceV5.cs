                        ...
                        ECPTData = new Core.DTO.eCPT.ECPTDataDto
                        {
                            TitlePage = new Core.DTO.eCPT.TitlePageDto
                            {
                                ...
                                ConditionDisease = design.Indications != null && design.Indications.Any() ?
                                                   ...
                                                   : null,
                                RegulatoryAgencyIdentifierNumbers = studyDto.StudyIdentifiers.Where(x => x.ScopeId != null && scopeLookup.ContainsKey(x.ScopeId) && Constants.IdType.RegulatoryAgencyIdentifierNumberConstants.Any(y => y.ToLower() == scopeLookup[x.ScopeId]?.Type?.Decode?.ToLower())).Any() ? _mapper.Map<List<Core.DTO.eCPT.RegulatoryAgencyIdentifierNumberDto>>(studyDto.StudyIdentifiers.Where(x => x.ScopeId != null && scopeLookup.ContainsKey(x.ScopeId) && Constants.IdType.RegulatoryAgencyIdentifierNumberConstants.Any(y => y.ToLower() == scopeLookup[x.ScopeId]?.Type?.Decode?.ToLower()))) : null,
                                SponsorName = studyDto.StudyIdentifiers.Where(x => x.ScopeId != null && scopeLookup.ContainsKey(x.ScopeId) && CodeValueHelper.IsSponsorDecode(scopeLookup[x.ScopeId].Type.Decode)).Select(x => scopeLookup[x.ScopeId].Name).FirstOrDefault(),
                                SponsorLegalAddress = studyDto.StudyIdentifiers.Where(x => x.ScopeId != null && scopeLookup.ContainsKey(x.ScopeId) && CodeValueHelper.IsSponsorDecode(scopeLookup[x.ScopeId].Type.Decode)).Select(x => scopeLookup[x.ScopeId].LegalAddress).FirstOrDefault() == null
                                                        ? null
                                                        : studyDto.StudyIdentifiers.Where(x => x.ScopeId != null && scopeLookup.ContainsKey(x.ScopeId) && CodeValueHelper.IsSponsorDecode(scopeLookup[x.ScopeId].Type.Decode)).Select(x => scopeLookup[x.ScopeId].LegalAddress).Select(x => $"{(x.Lines != null ? string.Join(", ", x.Lines) : "")}, {x.City}, {x.District}, {x.State}, {x.PostalCode}, {x.Country?.Decode}").FirstOrDefault(),
                                ...
                                {
                                    ProtocolID = studyDto.StudyIdentifiers.Where(x => x.ScopeId != null && scopeLookup.ContainsKey(x.ScopeId) && CodeValueHelper.IsSponsorDecode(scopeLookup[x.ScopeId].Type.Decode)).Select(x => x.Text).FirstOrDefault(),
