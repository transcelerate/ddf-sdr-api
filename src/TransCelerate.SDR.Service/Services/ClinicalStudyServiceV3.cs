...
namespace TransCelerate.SDR.Services.Services
{
    public class ClinicalStudyServiceV3 : IClinicalStudyServiceV3
    {
        ...
        public async Task<object> GetSOAV3(string studyId, string studyDesignId, string scheduleTimelineId, int sdruploadversion, LoggedInUser user)
        {
            try
            {
                _logger.LogInformation($"Started Service : {nameof(ClinicalStudyServiceV2)}; Method : {nameof(GetSOAV3)};");
                studyId = studyId.Trim();
            ...
            {
                _logger.LogInformation($"Ended Service : {nameof(ClinicalStudyServiceV2)}; Method : {nameof(GetSOAV3)};");
            }
        }
