    ...
    public class AutoMapperProfies : Profile
    {
        public AutoMapperProfies()
        {
            ...
            CreateMap<ClinicalStudyEntity, GetClinicalStudyDTO>()
                ...
                .ForMember(dest => dest.studyProtocol, opt => opt.MapFrom(src => src.currentSections.Select(x => x.studyProtocol).FirstOrDefault(s => s != null)));
            ...
            CreateMap<StudyEntity, AuditTrailDTO>()
                ...
                .ForMember(dest => dest.tag, opt => opt.MapFrom(src => src.clinicalStudy.tag))
                .ForMember(dest => dest.status, opt => opt.MapFrom(src => src.clinicalStudy.status))
