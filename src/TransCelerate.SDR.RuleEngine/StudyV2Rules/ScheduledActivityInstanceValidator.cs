    ...
    public class ScheduledActivityInstanceValidator : AbstractValidator<ScheduledActivityInstanceDto>
    {
        ...
        public ScheduledActivityInstanceValidator(IHttpContextAccessor httpContextAccessor)
        {
            ...
            RuleFor(x => x.ScheduleSeqenceNumber)
               ...
               .NotNull().WithMessage(Constants.ValidationErrorMessage.PropertyMissingError)
               .NotEmpty().WithMessage(Constants.ValidationErrorMessage.PropertyEmptyError)
               .When(x => RulesHelper.GetConformanceRules(_httpContextAccessor.HttpContext.Request.Headers[IdFieldPropertyName.Common.UsdmVersion], nameof(ScheduledActivityInstanceValidator), nameof(ScheduledActivityInstanceDto.ScheduleSeqenceNumber)), ApplyConditionTo.AllValidators);
