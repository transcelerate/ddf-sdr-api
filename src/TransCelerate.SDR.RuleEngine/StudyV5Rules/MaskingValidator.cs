    ...
    public class MaskingValidator : AbstractValidator<MaskingDto>
    {
        ...
        public MaskingValidator(IHttpContextAccessor httpContextAccessor)
        {
            ...
            RuleFor(x => x.Id)
                ...
                .When(x => RulesHelper.GetConformanceRules(_httpContextAccessor.HttpContext.Request.Headers[IdFieldPropertyName.Common.UsdmVersion], nameof(MaskingValidator), nameof(MaskingDto.Id)), ApplyConditionTo.AllValidators);
