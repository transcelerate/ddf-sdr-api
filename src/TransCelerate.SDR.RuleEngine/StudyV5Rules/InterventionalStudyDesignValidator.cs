    ...
    public class InterventionalStudyDesignValidator : AbstractValidator<InterventionalStudyDesignDto>
    {
        ...
        public InterventionalStudyDesignValidator(IHttpContextAccessor httpContextAccessor)
        {
            ...
            RuleFor(x => x.TheraputicAreas)
                ...
                .NotNull().WithMessage(Constants.ValidationErrorMessage.PropertyMissingError)
                .NotEmpty().WithMessage(Constants.ValidationErrorMessage.PropertyEmptyError)
                .When(x => RulesHelper.GetConformanceRules(_httpContextAccessor.HttpContext.Request.Headers[IdFieldPropertyName.Common.UsdmVersion], nameof(InterventionalStudyDesignValidator), nameof(InterventionalStudyDesignDto.TheraputicAreas)), ApplyConditionTo.AllValidators);
