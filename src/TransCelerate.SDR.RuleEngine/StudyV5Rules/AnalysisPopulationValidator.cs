    ...
    public class AnalysisPopulationValidator : AbstractValidator<AnalysisPopulationDto>
    {
        ...
        public AnalysisPopulationValidator(IHttpContextAccessor httpContextAccessor)
        {
            ...
            RuleFor(x => x.InstanceType)
                ...
                .NotNull().WithMessage(Constants.ValidationErrorMessage.PropertyMissingError)
                .NotEmpty().WithMessage(Constants.ValidationErrorMessage.PropertyEmptyError)
                .When(x => RulesHelper.GetConformanceRules(_httpContextAccessor.HttpContext.Request.Headers[IdFieldPropertyName.Common.UsdmVersion], nameof(AnalysisPopulationValidator), nameof(AnalysisPopulationDto.InstanceType)), ApplyConditionTo.AllValidators)
