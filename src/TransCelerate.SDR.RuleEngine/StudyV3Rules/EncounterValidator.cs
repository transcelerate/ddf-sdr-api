    ...
    public class EncounterValidator : AbstractValidator<EncounterDto>
    {
        ...
        public EncounterValidator(IHttpContextAccessor httpContextAccessor)
        {
            ...
            RuleFor(x => x.Id)
               ...
               .NotNull().OverridePropertyName(IdFieldPropertyName.StudyV3.EncounterId).WithMessage(Constants.ValidationErrorMessage.PropertyMissingError)
               .NotEmpty().OverridePropertyName(IdFieldPropertyName.StudyV3.EncounterId).WithMessage(Constants.ValidationErrorMessage.PropertyEmptyError)
