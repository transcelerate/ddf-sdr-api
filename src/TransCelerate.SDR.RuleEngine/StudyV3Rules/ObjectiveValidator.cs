    ...
    public class ObjectiveValidator : AbstractValidator<ObjectiveDto>
    {
        ...
        public ObjectiveValidator(IHttpContextAccessor httpContextAccessor)
        {
            ...
            RuleFor(x => x.Id)
               ...
               .NotNull().OverridePropertyName(IdFieldPropertyName.StudyV3.ObjectiveId).WithMessage(Constants.ValidationErrorMessage.PropertyMissingError)
               .NotEmpty().OverridePropertyName(IdFieldPropertyName.StudyV3.ObjectiveId).WithMessage(Constants.ValidationErrorMessage.PropertyEmptyError)
