    ...
    public class BiomedicalConceptPropertyValidator : AbstractValidator<BiomedicalConceptPropertyDto>
    {
        ...
        public BiomedicalConceptPropertyValidator(IHttpContextAccessor httpContextAccessor)
        {
            ...
            RuleFor(x => x.Id)
               ...
               .NotNull().OverridePropertyName(IdFieldPropertyName.StudyV3.BcPropertyId).WithMessage(Constants.ValidationErrorMessage.PropertyMissingError)
               .NotEmpty().OverridePropertyName(IdFieldPropertyName.StudyV3.BcPropertyId).WithMessage(Constants.ValidationErrorMessage.PropertyEmptyError)
