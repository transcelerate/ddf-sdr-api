    ...
    public class ResponseCodeValidator : AbstractValidator<ResponseCodeDto>
    {
        ...
        public ResponseCodeValidator(IHttpContextAccessor httpContextAccessor)
        {
            ...
            RuleFor(x => x.Id)
               ...
               .NotNull().OverridePropertyName(IdFieldPropertyName.StudyV3.ResponseCodeId).WithMessage(Constants.ValidationErrorMessage.PropertyMissingError)
               .NotEmpty().OverridePropertyName(IdFieldPropertyName.StudyV3.ResponseCodeId).WithMessage(Constants.ValidationErrorMessage.PropertyEmptyError)
