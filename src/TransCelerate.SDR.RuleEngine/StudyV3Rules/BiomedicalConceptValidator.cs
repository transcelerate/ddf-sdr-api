    ...
    public class BiomedicalConceptValidator : AbstractValidator<BiomedicalConceptDto>
    {
        ...
        public BiomedicalConceptValidator(IHttpContextAccessor httpContextAccessor)
        {
            ...
            RuleFor(x => x.Id)
               ...
               .NotNull().OverridePropertyName(IdFieldPropertyName.StudyV3.BiomedicalConceptId).WithMessage(Constants.ValidationErrorMessage.PropertyMissingError)
               .NotEmpty().OverridePropertyName(IdFieldPropertyName.StudyV3.BiomedicalConceptId).WithMessage(Constants.ValidationErrorMessage.PropertyEmptyError)
