    ...
    public class BiomedicalConceptSurrogateValidator : AbstractValidator<BiomedicalConceptSurrogateDto>
    {
        ...
        public BiomedicalConceptSurrogateValidator(IHttpContextAccessor httpContextAccessor)
        {
            ...
            RuleFor(x => x.Id)
               ...
               .NotNull().OverridePropertyName(IdFieldPropertyName.StudyV3.BcSurrogateId).WithMessage(Constants.ValidationErrorMessage.PropertyMissingError)
               .NotEmpty().OverridePropertyName(IdFieldPropertyName.StudyV3.BcSurrogateId).WithMessage(Constants.ValidationErrorMessage.PropertyEmptyError)
