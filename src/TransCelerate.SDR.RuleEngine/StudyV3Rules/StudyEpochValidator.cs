    ...
    public class StudyEpochValidator : AbstractValidator<StudyEpochDto>
    {
        ...
        public StudyEpochValidator(IHttpContextAccessor httpContextAccessor)
        {
            ...
            RuleFor(x => x.Id)
               ...
               .NotNull().OverridePropertyName(IdFieldPropertyName.StudyV3.StudyEpochId).WithMessage(Constants.ValidationErrorMessage.PropertyMissingError)
               .NotEmpty().OverridePropertyName(IdFieldPropertyName.StudyV3.StudyEpochId).WithMessage(Constants.ValidationErrorMessage.PropertyEmptyError)
