    ...
    public class ActivityValidator : AbstractValidator<ActivityDto>
    {
        ...
        public ActivityValidator(IHttpContextAccessor httpContextAccessor)
        {
            ...
            RuleFor(x => x.Id)
               ...
               .NotNull().OverridePropertyName(IdFieldPropertyName.StudyV3.ActivityId).WithMessage(Constants.ValidationErrorMessage.PropertyMissingError)
               .NotEmpty().OverridePropertyName(IdFieldPropertyName.StudyV3.ActivityId).WithMessage(Constants.ValidationErrorMessage.PropertyEmptyError)
