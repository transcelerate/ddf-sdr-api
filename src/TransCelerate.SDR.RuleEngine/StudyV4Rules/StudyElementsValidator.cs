    ...
    public class StudyElementsValidator : AbstractValidator<StudyElementDto>
    {
        ...
        public StudyElementsValidator(IHttpContextAccessor httpContextAccessor)
        {
            ...
            RuleFor(x => x.InstanceType)
               ...
               .NotNull().WithMessage(Constants.ValidationErrorMessage.PropertyMissingError)
               .NotEmpty().WithMessage(Constants.ValidationErrorMessage.PropertyEmptyError)
               .When(x => RulesHelper.GetConformanceRules(_httpContextAccessor.HttpContext.Request.Headers[IdFieldPropertyName.Common.UsdmVersion], nameof(StudyElementsValidator), nameof(StudyElementDto.InstanceType)), ApplyConditionTo.AllValidators)
            ...
            RuleFor(x => x.Label)
                ...
                .NotNull().WithMessage(Constants.ValidationErrorMessage.PropertyMissingError)
                .NotEmpty().WithMessage(Constants.ValidationErrorMessage.PropertyEmptyError)
                .When(x => RulesHelper.GetConformanceRules(_httpContextAccessor.HttpContext.Request.Headers[IdFieldPropertyName.Common.UsdmVersion], nameof(StudyElementsValidator), nameof(StudyElementDto.Label)), ApplyConditionTo.AllValidators);
