...
Study protocols are available as USDM 4.0 conformant JSON files.  Some of the sample protocols also include the original PDF.  All sample protocols are publicly available.  The USDM conformant representations are not guaranteed to be "complete" representations of the original PDF, but are meant to demonstrate how the protocol is mapped. The sample protocols are continuously updated and refined and will be maintained here.
