    ...
    public class StudyElementsValidator : AbstractValidator<StudyElementDto>
    {
        ...
        public StudyElementsValidator(IHttpContextAccessor httpContextAccessor)
        {
            ...
            RuleFor(x => x.Id)
               ...
               .NotNull().OverridePropertyName(IdFieldPropertyName.StudyV3.StudyElementId).WithMessage(Constants.ValidationErrorMessage.PropertyMissingError)
               .NotEmpty().OverridePropertyName(IdFieldPropertyName.StudyV3.StudyElementId).WithMessage(Constants.ValidationErrorMessage.PropertyEmptyError)
