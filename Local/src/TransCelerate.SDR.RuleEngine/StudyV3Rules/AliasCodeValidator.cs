    ...
    public class AliasCodeValidator : AbstractValidator<AliasCodeDto>
    {
        ...
        public AliasCodeValidator(IHttpContextAccessor httpContextAccessor)
        {
            ...
            RuleFor(x => x.Id)
                ...
                .NotNull().OverridePropertyName(IdFieldPropertyName.StudyV3.AliasCodeId).WithMessage(Constants.ValidationErrorMessage.PropertyMissingError)
                .NotEmpty().OverridePropertyName(IdFieldPropertyName.StudyV3.AliasCodeId).WithMessage(Constants.ValidationErrorMessage.PropertyEmptyError)
