    ...
    public class StudyArmValidator : AbstractValidator<StudyArmDto>
    {
        ...
        public StudyArmValidator(IHttpContextAccessor httpContextAccessor)
        {
            ...
            RuleFor(x => x.Id)
               ...
               .NotNull().OverridePropertyName(IdFieldPropertyName.StudyV3.StudyArmId).WithMessage(Constants.ValidationErrorMessage.PropertyMissingError)
               .NotEmpty().OverridePropertyName(IdFieldPropertyName.StudyV3.StudyArmId).WithMessage(Constants.ValidationErrorMessage.PropertyEmptyError)
