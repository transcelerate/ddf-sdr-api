...
{
	public class StudyRepositoryV5 : IStudyRepositoryV5
	{
		#region Variables     
		...
		#region Constructor      
		public StudyRepositoryV5(IMongoClient client, ILogHelper logger)
		{
			_client = client;
		...
		public async Task<StudyDefinitionsEntity> GetStudyItemsAsync(string studyId, int sdruploadversion)
		{
			...
			try
			{
				...
				StudyDefinitionsEntity study = await collection.Find(DataFiltersV5.GetFiltersForGetStudy(studyId, sdruploadversion))
		...
		{
			_logger.LogInformation($"Started Repository : {nameof(StudyRepositoryV5)}; Method : {nameof(GetPartialStudyItemsAsync)};");
			try
			{
				IMongoCollection<StudyDefinitionsEntity> collection = _database.GetCollection<StudyDefinitionsEntity>(Constants.Collections.StudyDefinitions);
				...
				StudyDefinitionsEntity study = await collection.Find(DataFiltersV5.GetFiltersForGetStudy(studyId, sdruploadversion))
													 .SortByDescending(s => s.AuditTrail.EntryDateTime) // Sort by descending on entryDateTime
													 .Limit(1)                  //Taking top 1 result
																				//.Project<StudyDefinitionsEntity>(DataFiltersV5.GetProjectionForPartialStudyElements(listofelementsArray))
													 .SingleOrDefaultAsync().ConfigureAwait(false);
			...
			{
				_logger.LogInformation($"Ended Repository : {nameof(StudyRepositoryV5)}; Method : {nameof(GetPartialStudyItemsAsync)};");
			}
		}
		...
		public async Task<StudyDefinitionsEntity> GetPartialStudyDesignItemsAsync(string studyId, int sdruploadversion)
		{
			...
			try
			{
				...
				StudyDefinitionsEntity study = await collection.Find(DataFiltersV5.GetFiltersForGetStudy(studyId, sdruploadversion))
													 //.Project<StudyDefinitionsEntity>(DataFiltersV5.GetProjectionForPartialStudyDesignElementsFullStudy())
													 .SortByDescending(s => s.AuditTrail.EntryDateTime) // Sort by descending on entryDateTime
													 .Limit(1)                  //Taking top 1 result                                                     
		...
		{
			_logger.LogInformation($"Started Repository : {nameof(StudyRepositoryV3)}; Method : {nameof(GetStudyItemsForCheckingAccessAsync)};");
			try
			{
				IMongoCollection<StudyDefinitionsEntity> collection = _database.GetCollection<StudyDefinitionsEntity>(Constants.Collections.StudyDefinitions);
				...
				StudyDefinitionsEntity study = await collection.Find(DataFiltersV5.GetFiltersForGetStudy(studyId, sdruploadversion))
													 .SortByDescending(s => s.AuditTrail.EntryDateTime) // Sort by descending on entryDateTime
													 .Project<StudyDefinitionsEntity>(DataFiltersV5.GetProjectionForCheckAccessForAStudy())
													 .Limit(1)                  //Taking top 1 result
													 .SingleOrDefaultAsync().ConfigureAwait(false);
			...
			{
				_logger.LogInformation($"Ended Repository : {nameof(StudyRepositoryV3)}; Method : {nameof(GetStudyItemsForCheckingAccessAsync)};");
			}
		}
		#endregion
		...
		public async Task<AuditTrailEntity> GetUsdmVersionAsync(string studyId, int sdruploadversion)
		{
			...
			try
			{
				...
				AuditTrailEntity auditTrail = await collection.Find(DataFiltersV5.GetFiltersForGetAuditTrailOfAStudy(studyId, sdruploadversion))
													 .SortByDescending(s => s.AuditTrail.EntryDateTime) // Sort by descending on entryDateTime
													 .Limit(1)                  //Taking top 1 result
